...
export const GoogleGlass = {
  ...
  description: {
    ...
    en: "OK Google - let's bring Glasses back, we are ready this time.",
...
export const IOT = {
  ...
  description: {
    ...
    en: "Working on IOT sensors using Interstacks and Azure.",
...
export const MagicLeap = {
  ...
  description: {
    ...
    en: "First time creating AR application using MagicLeap. No one told me I would need to learn Unity.",
